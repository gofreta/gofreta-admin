<template>
    <div>
        <popup title="Switch/Boolean Field" ref="formPopup">
            <form class="block" @submit.prevent="onSubmit" @reset="onReset">
                ...
                <div class="form-group form-group-switch form-group-color-success">
                    <input type="checkbox" v-model="field.default" :id="'field_default_val' + formKey">
                    <label :for="'field_default_val' + formKey">Default state</span></label>
                </div>
...
import { CFSwitchModel }  from '@/models/CFSwitchModel'
